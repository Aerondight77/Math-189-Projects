...
for (i in 1:num_folds) {
  ...
  test_class_preds <- ifelse(test_preds > 0.5, "Yes", "No")
  
  # Calculate accuracy
  accuracy[i] <- mean(test_class_preds == test_data$Private)
}

# Calculate and print the average test error
...
plot.roc(College$Private, predict(logreg_model, type = "response"))
...
Logistic Regression has the lowest prediction error, therefor it is the best choice of model to predict whether a school is Private or not. 
